...
def run_engine(df_1m: pd.DataFrame, df_30s: pd.DataFrame, allow_counter_candle_entry: bool) -> List[Trade]:
    ...
    _pwin_path   = "/Users/radhikaarora/Documents/Trading ML/ML V2/entry_model_pwin_13features_retrained_timefeatures.joblib"
    ml_model     = joblib.load(_pwin_path) if os.path.exists(_pwin_path) else None
    ml_features  = ['retrace','pivot_flem_dist','time_since_pivot_sec','body_last','body_sum','body_mean','in_dir_ratio','max_in_dir_run','bars_since_pivot','zone_over_range','pivot_over_range','dist_to_extrema_atr','zone_to_extrema_atr','min_since_pivot','min_since_930']
                    ...
                    if ml_model is not None and ml_features is not None and last_30s_close is not None:
                        ...
                        if pivot_flem_dist not in (0, None) and time_since_pivot is not None and body_count_30s > 0:
                            ...
                            if retrace_ml is not None:
                                ...
                                min_since_930 = (t - zone_time).total_seconds() / 60.0
                                ...
                                features = {
                                    ...
                                    'min_since_pivot': min_since_pivot,
                                    'min_since_930': min_since_930,
                                }
...
def main():
    ...
    out_allow_path = "/Users/radhikaarora/Documents/Trading ML/ML V2/output_bnr_det_2025_13feat_pwin50_timefeatures.csv"
    ...
    out_2026_path = "/Users/radhikaarora/Documents/Trading ML/ML V2/output_bnr_det_2026_13feat_pwin50_timefeatures.csv"
    ...
    out_mar26_path = "/Users/radhikaarora/Documents/Trading ML/ML V2/output_bnr_det_mar2026_13feat_pwin50_timefeatures.csv"
