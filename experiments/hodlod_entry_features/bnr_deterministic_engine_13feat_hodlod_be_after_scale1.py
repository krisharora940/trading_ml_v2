...
def run_engine(df_1m: pd.DataFrame, df_30s: pd.DataFrame, allow_counter_candle_entry: bool, pwin_thresh: float = 0.50) -> List[Trade]:
    trades: List[Trade] = []
    ...
    _pwin_path   = os.environ.get(
        "PWIN_MODEL_PATH",
        "/Users/radhikaarora/Documents/Trading ML/ML V2/entry_model_pwin_13features_hodlod_baseline.joblib",
    )
                        ...
                        if direction == 'long':
                            ...
                            if close <= active_stop_price:
                                ...
                                if scale_out_active and scale_out_stage < len(scale_out_plan) - 1:
                                    ...
                                    remaining_stop = float(current.entry_price) if scale_out_stage >= 1 else current.stop_price
...
def main():
    ...
    # Only 2025 data available in quarterly files
    ...
    out_allow_path = "/Users/radhikaarora/Documents/Trading ML/ML V2/output_bnr_det_2025_13feat_pwin50_hodlod_entry.csv"
