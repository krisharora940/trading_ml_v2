...
DEFAULT_BACKTEST_CSV = os.path.join(BASE, "outputs/output_bnr_det_2025_15feat_baseline_hodlod_scaleoutfix_nogates_pwin50.csv")
DEFAULT_BARS_30S_Q   = [
...
DEFAULT_OUT_MODEL    = os.path.join(BASE, "entry_model_pwin_15features_hodlod_baseline_nogates_retrained.joblib")
DEFAULT_OUT_CSV      = os.path.join(BASE, "ml_features_15feat_hodlod_baseline_nogates_retrained.csv")


def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Retrain pwin model (baseline HOD/LOD no-gates set).")
