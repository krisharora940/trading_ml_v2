...
OUT_MODEL    = os.path.join(BASE, "entry_model_pwin_13features_retrained_timefeatures.joblib")
OUT_CSV      = os.path.join(BASE, "ml_features_13feat_retrain_timefeatures.csv")
...
for _, tr in bt_u.iterrows():
    ...
    session_start = pd.Timestamp(f"{day} 09:30:00", tz=ET)
    min_since_930 = (entry_time - session_start).total_seconds() / 60.0
