...
def run_engine(df_1m: pd.DataFrame, df_30s: pd.DataFrame, allow_counter_candle_entry: bool) -> List[Trade]:
    ...
    _pwin_path   = "/Users/radhikaarora/Documents/Trading ML/ML V2/entry_model_pwin_13features.joblib"
    ml_model     = joblib.load(_pwin_path) if os.path.exists(_pwin_path) else None
    ml_features  = ['retrace','pivot_flem_dist','time_since_pivot_sec','body_last','body_sum','body_mean','in_dir_ratio','max_in_dir_run','bars_since_pivot','zone_over_range','pivot_over_range','dist_to_extrema_atr','zone_to_extrema_atr']
                ...
                if current.outcome is None:
                        ...
                        if direction == 'long':
                            ...
                            if close <= stop_price:
                                ...
                                scale_out_active = False
                                scale_out_stage = 0
                                # NO reset after close — require fresh retest for re-entry
                                entry_triggered = True  # blocks re-entry until new pivot forms
...
def main():
    ...
    out_allow_path = "/Users/radhikaarora/Documents/Trading ML/ML V2/output_bnr_det_2025_13feat_pwin50_retrained_noreset.csv"
    ...
    out_2026_path = "/Users/radhikaarora/Documents/Trading ML/ML V2/output_bnr_det_2026_13feat_pwin50_retrained_noreset.csv"
